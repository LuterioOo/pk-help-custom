...
export function MobileStickyCta() {
  ...
  return (
    <div
      ...
      aria-hidden={false}
    >
      <div className="pointer-events-auto max-w-lg mx-auto glass-strong rounded-xl border border-yellow-500/20 shadow-[0_-8px_32px_rgba(0,0,0,0.5)] p-1.5 grid grid-cols-[1.4fr_1fr_1fr] gap-1">
        <Link
          href={builderHref}
          className={cn(
            "flex items-center justify-center gap-1.5 rounded-lg px-2 py-2.5 text-xs font-bold",
