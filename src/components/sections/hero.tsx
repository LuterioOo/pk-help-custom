...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative pt-[3.25rem] sm:pt-[5rem] md:pt-[6.25rem] pb-3 sm:pb-10 px-3 sm:px-4 md:px-8 min-h-0 sm:min-h-[min(88vh,820px)] md:min-h-[min(92vh,880px)] flex flex-col justify-start sm:justify-center"
    >
