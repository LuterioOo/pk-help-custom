...
const schema = z.object({
  ...
  titleUk: z.string().max(200).optional().or(z.literal("")),
  titleEn: z.string().max(200).optional().or(z.literal("")),
  titlePl: z.string().max(200).optional().or(z.literal("")),
  caption: z.string().max(500).optional().or(z.literal("")),
  captionUk: z.string().max(500).optional().or(z.literal("")),
  captionEn: z.string().max(500).optional().or(z.literal("")),
  captionPl: z.string().max(500).optional().or(z.literal("")),
...
export async function POST(req: NextRequest) {
  ...
  const item = await prisma.showcaseBuild.create({
    data: {
      ...
      captionUk: data.captionUk || null,
      captionEn: data.captionEn || null,
      captionPl: data.captionPl || null,
